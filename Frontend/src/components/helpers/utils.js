...
export const penyakit = {
    "flu": "Flu adalah infeksi virus yang umum dan bisa mematikan terutama pada kelompok berisiko tinggi. Gejalanya termasuk demam, batuk, sakit tenggorokan, hidung meler atau tersumbat, nyeri otot atau tubuh, sakit kepala, dan kelelahan. Obat herbal yang cocok: Teh Jahe, Teh Kunyit. [chatWithAdminButton]",
    "teh jahe" : "Untuk membuat teh jahe, cuci dan kupas 2 inci jahe segar, lalu iris tipis. Rebus 2 gelas air, tambahkan irisan jahe, dan biarkan mendidih selama 10-15 menit. Saring teh ke dalam cangkir dan tambahkan madu serta lemon sesuai selera. Alternatifnya, parut atau potong kecil-kecil jahe segar, campurkan dengan 2-3 sendok makan madu, dan konsumsi 1 sendok teh campuran ini 2-3 kali sehari.",
    "teh kunyit" : "Untuk membuat teh kunyit, rebus 2 gelas air, tambahkan 1 sendok teh kunyit bubuk atau parutan dari 1 inci kunyit segar, dan biarkan mendidih selama 10-15 menit. Saring teh ke dalam cangkir dan tambahkan madu serta lemon sesuai selera. Untuk susu kunyit (golden milk), panaskan 1 gelas susu, tambahkan 1 sendok teh kunyit bubuk atau parutan dari 1 inci kunyit segar, serta 1/2 sendok teh lada hitam, aduk selama 5-10 menit, saring ke dalam cangkir, dan tambahkan madu sesuai selera.",
