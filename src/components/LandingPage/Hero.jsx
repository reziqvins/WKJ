      ...
      <div className="md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px] md:px-0">
        <div className="flex flex-col justify-start gap-4">
          ...
          <h1 className="md:leading-[72px] py-2 md:text-6xl text-5xl font-semibold">
            Hidup Lebih Sehat Bersama UPTD Kesehatan Jamu
          </h1>
          <p className="py-2 text-lg text-gray-600">
            Menyatu dengan <span className="text-[#20B486]">Alam</span>,
            Menghadirkan Kesembuhan dengan{" "}
            <span className="text-[#20B486]">Tanaman Herbal</span>.
          </p>
